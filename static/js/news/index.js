$(function () {
    ...
    $newsLi.click(function () {
        ...
        if (sClickTagId !== sCurrentTagId) {  // 如果重复点击同一个标签不重复刷新
    ...
    let $click_load_content = $(".btn-more");
    $click_load_content.click(function () {
        // 判断页数，去更新新闻数据
                          ...
                          <li class="news-item">
                             ...
                             <div class="news-content">
                                ...
                                <div class="news-other">
                                  ...
                                  <span class="news-time">${dateFormat(one_news.update_time)}</span>
